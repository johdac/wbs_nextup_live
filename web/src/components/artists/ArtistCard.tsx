...
export const ArtistCard = ({ artist }: { artist: Artist }) => {
  return (
    <>
      <div key={artist.id} className="grid md:grid-cols-3 py-3 rounded-lg mb-2 gap-5">
        <img
        ...
        <div className="flex gap-2">
          <div className="gap-1">
            <Link to={`/artist/${artist.id}`}>
              <h3 className="transition-colors duration-100 hover:text-purple cursor-pointer">{artist.name}</h3>
              <div
